---
title: "Zero-Explanation Refactoring"
description: "Requests raw code output only during automated file editing tasks."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, zero-explanation-refactoring"
category: "Token Efficiency and Performance"
---

# Zero-Explanation Refactoring

## Overview
Requests raw code output only during automated file editing tasks.

---

## Operational Directives and Agent Execution Rules
When applying **Zero-Explanation Refactoring**, the AI agent or LLM runtime MUST adhere to the following rules:
