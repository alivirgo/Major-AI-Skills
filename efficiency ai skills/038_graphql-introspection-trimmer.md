---
title: "GraphQL Schema Trimmer"
description: "Prunes unused GraphQL types from schema definitions."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, graphql-introspection-trimmer"
category: "Token Efficiency and Performance"
---

# GraphQL Schema Trimmer

## Overview
Prunes unused GraphQL types from schema definitions.

---

## Operational Directives and Agent Execution Rules
When applying **GraphQL Schema Trimmer**, the AI agent or LLM runtime MUST adhere to the following rules:
