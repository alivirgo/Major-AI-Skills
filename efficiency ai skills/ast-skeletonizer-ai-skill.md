---
title: "AST Code Skeletonizer"
description: "Strips function bodies from source files, exposing only class/function signatures for RAG indexing."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, ast-skeletonizer"
category: "Token Efficiency and Performance"
---

# AST Code Skeletonizer

## Overview
Strips function bodies from source files, exposing only class/function signatures for RAG indexing.

---

## Operational Directives and Agent Execution Rules
When applying **AST Code Skeletonizer**, the AI agent or LLM runtime MUST adhere to the following rules:
