---
title: "No-Preamble Code Output"
description: "Directly starts responses with fenced code blocks without 'Here is the code:' intro lines."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, no-preamble-code-blocks"
category: "Token Efficiency and Performance"
---

# No-Preamble Code Output

## Overview
Directly starts responses with fenced code blocks without 'Here is the code:' intro lines.

---

## Operational Directives and Agent Execution Rules
When applying **No-Preamble Code Output**, the AI agent or LLM runtime MUST adhere to the following rules:
