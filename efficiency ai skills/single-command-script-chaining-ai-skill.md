---
title: "Single-Command Script Chaining"
description: "Chains setup commands using ; or && in a single execution call."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, single-command-script-chaining"
category: "Token Efficiency and Performance"
---

# Single-Command Script Chaining

## Overview
Chains setup commands using ; or && in a single execution call.

---

## Operational Directives and Agent Execution Rules
When applying **Single-Command Script Chaining**, the AI agent or LLM runtime MUST adhere to the following rules:
