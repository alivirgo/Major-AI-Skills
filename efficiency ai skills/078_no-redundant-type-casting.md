---
title: "Eliminate Redundant Type Casting"
description: "Removes unnecessary type conversions in dynamic languages."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, no-redundant-type-casting"
...
## Overview
Removes unnecessary type conversions in dynamic languages.

---

## Operational Directives and Agent Execution Rules
When applying **Eliminate Redundant Type Casting**, the AI agent or LLM runtime MUST adhere to the following rules:
