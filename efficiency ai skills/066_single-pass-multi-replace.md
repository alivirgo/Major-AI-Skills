---
title: "Single-Pass Multi-Replace Tool"
description: "Applies multiple non-contiguous edits in a single tool call payload."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, single-pass-multi-replace"
category: "Token Efficiency and Performance"
---

# Single-Pass Multi-Replace Tool

## Overview
Applies multiple non-contiguous edits in a single tool call payload.

---

## Operational Directives and Agent Execution Rules
When applying **Single-Pass Multi-Replace Tool**, the AI agent or LLM runtime MUST adhere to the following rules:
