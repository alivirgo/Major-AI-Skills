---
title: "Concise Output Enforcer"
description: "Instructs AI agents to strip conversational filler, preambles, and post-summaries to cut response token usage by 50%."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, concise-output-enforcer"
category: "Token Efficiency and Performance"
---

# Concise Output Enforcer

## Overview
Instructs AI agents to strip conversational filler, preambles, and post-summaries to cut response token usage by 50%.

---

## Operational Directives and Agent Execution Rules
When applying **Concise Output Enforcer**, the AI agent or LLM runtime MUST adhere to the following rules:
