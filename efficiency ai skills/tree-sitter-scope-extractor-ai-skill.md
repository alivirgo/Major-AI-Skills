---
title: "Tree-Sitter Scope Extractor"
description: "Extracts only the target enclosing function scope for context window insertion."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, tree-sitter-scope-extractor"
category: "Token Efficiency and Performance"
---

# Tree-Sitter Scope Extractor

## Overview
Extracts only the target enclosing function scope for context window insertion.

---

## Operational Directives and Agent Execution Rules
When applying **Tree-Sitter Scope Extractor**, the AI agent or LLM runtime MUST adhere to the following rules:
