---
title: "Compact Error Handling"
description: "Combines duplicate exception handling blocks into single multi-exception handlers."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, compact-error-handling"
...
## Overview
Combines duplicate exception handling blocks into single multi-exception handlers.

---

## Operational Directives and Agent Execution Rules
When applying **Compact Error Handling**, the AI agent or LLM runtime MUST adhere to the following rules:
