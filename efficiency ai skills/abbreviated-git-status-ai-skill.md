---
title: "Abbreviated Git Status Inspection"
description: "Uses git status -s instead of verbose git status to save context tokens."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, abbreviated-git-status"
category: "Token Efficiency and Performance"
---

# Abbreviated Git Status Inspection

## Overview
Uses git status -s instead of verbose git status to save context tokens.

---

## Operational Directives and Agent Execution Rules
When applying **Abbreviated Git Status Inspection**, the AI agent or LLM runtime MUST adhere to the following rules:
