---
title: "Minimal Diff Formatter"
description: "Enforces unified 3-line context unified diff output instead of rewriting full files."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, minimal-diff-formatter"
...
## Overview
Enforces unified 3-line context unified diff output instead of rewriting full files.

---

## Operational Directives and Agent Execution Rules
When applying **Minimal Diff Formatter**, the AI agent or LLM runtime MUST adhere to the following rules:
