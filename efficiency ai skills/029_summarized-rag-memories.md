---
title: "Summarized RAG Memory Ingestion"
description: "Compresses retrieved past conversation logs into 3-bullet key facts before sending to LLM."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, summarized-rag-memories"
category: "Token Efficiency and Performance"
---

# Summarized RAG Memory Ingestion

## Overview
Compresses retrieved past conversation logs into 3-bullet key facts before sending to LLM.

---

## Operational Directives and Agent Execution Rules
When applying **Summarized RAG Memory Ingestion**, the AI agent or LLM runtime MUST adhere to the following rules:
