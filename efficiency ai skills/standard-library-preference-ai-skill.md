---
title: "Standard Library Preference"
description: "Uses built-in OS/language utilities to avoid writing custom helper functions."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, standard-library-preference"
...
## Overview
Uses built-in OS/language utilities to avoid writing custom helper functions.

---

## Operational Directives and Agent Execution Rules
When applying **Standard Library Preference**, the AI agent or LLM runtime MUST adhere to the following rules:
