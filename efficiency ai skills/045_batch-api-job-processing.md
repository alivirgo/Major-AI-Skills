...
description: "Uses asynchronous Batch APIs for non-realtime evaluation to cut API costs in half."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, batch-api-job-processing"
...
## Overview
Uses asynchronous Batch APIs for non-realtime evaluation to cut API costs in half.

---

## Operational Directives and Agent Execution Rules
When applying **Batch API Processing**, the AI agent or LLM runtime MUST adhere to the following rules:
