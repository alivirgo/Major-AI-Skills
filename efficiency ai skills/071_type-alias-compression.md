---
title: "Type Alias Compression"
description: "Uses short type aliases to avoid repeating long generic type signatures."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, type-alias-compression"
...
## Overview
Uses short type aliases to avoid repeating long generic type signatures.

---

## Operational Directives and Agent Execution Rules
When applying **Type Alias Compression**, the AI agent or LLM runtime MUST adhere to the following rules:
