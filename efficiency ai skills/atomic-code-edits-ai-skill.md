---
title: "Atomic Code Edits"
description: "Applies exact character replacements to prevent accidental code regression."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, atomic-code-edits"
...
## Overview
Applies exact character replacements to prevent accidental code regression.

---

## Operational Directives and Agent Execution Rules
When applying **Atomic Code Edits**, the AI agent or LLM runtime MUST adhere to the following rules:
