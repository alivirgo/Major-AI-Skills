---
title: "Compact Enum Mappings"
description: "Replaces long string identifiers with single-integer status codes in prompt exchanges."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, compact-enum-mappings"
...
## Overview
Replaces long string identifiers with single-integer status codes in prompt exchanges.

---

## Operational Directives and Agent Execution Rules
When applying **Compact Enum Mappings**, the AI agent or LLM runtime MUST adhere to the following rules:
