---
title: "Minimal Artifact Metadata"
description: "Updates artifact summaries concisely to save metadata token overhead."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, minimal-artifact-metadata"
...
## Overview
Updates artifact summaries concisely to save metadata token overhead.

---

## Operational Directives and Agent Execution Rules
When applying **Minimal Artifact Metadata**, the AI agent or LLM runtime MUST adhere to the following rules:
