...
description: "Splits documentation on semantic boundary markers matching exact embedding model limits."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, token-aware-chunking"
...
## Overview
Splits documentation on semantic boundary markers matching exact embedding model limits.

---

## Operational Directives and Agent Execution Rules
When applying **Token-Aware Text Chunking**, the AI agent or LLM runtime MUST adhere to the following rules:
