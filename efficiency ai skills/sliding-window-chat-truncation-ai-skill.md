---
title: "Sliding Window Chat Truncation"
description: "Automatically drops messages older than N turns when nearing token ceiling."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, sliding-window-chat-truncation"
...
## Overview
Automatically drops messages older than N turns when nearing token ceiling.

---

## Operational Directives and Agent Execution Rules
When applying **Sliding Window Chat Truncation**, the AI agent or LLM runtime MUST adhere to the following rules:
