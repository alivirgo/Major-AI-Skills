---
title: "Compact System Error Codes"
description: "Maps long error messages to short error IDs in prompt context."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, compact-error-codes"
category: "Token Efficiency and Performance"
---

# Compact System Error Codes

## Overview
Maps long error messages to short error IDs in prompt context.

---

## Operational Directives and Agent Execution Rules
When applying **Compact System Error Codes**, the AI agent or LLM runtime MUST adhere to the following rules:
