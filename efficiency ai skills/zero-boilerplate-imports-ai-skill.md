---
title: "Zero-Boilerplate Imports"
description: "Omits standard library imports in patch snippets when existing file already contains them."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, zero-boilerplate-imports"
...
## Overview
Omits standard library imports in patch snippets when existing file already contains them.

---

## Operational Directives and Agent Execution Rules
When applying **Zero-Boilerplate Imports**, the AI agent or LLM runtime MUST adhere to the following rules:
