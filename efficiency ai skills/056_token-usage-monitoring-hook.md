---
title: "Token Usage Monitoring Hook"
description: "Tracks input/output token counts per tool call to alert on high-consumption spikes."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, token-usage-monitoring-hook"
...
## Overview
Tracks input/output token counts per tool call to alert on high-consumption spikes.

---

## Operational Directives and Agent Execution Rules
When applying **Token Usage Monitoring Hook**, the AI agent or LLM runtime MUST adhere to the following rules:
