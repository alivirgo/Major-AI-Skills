---
title: "Single-Line Error Summaries"
description: "Compresses 100-line stack traces into single-line root cause statements."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, single-line-error-summaries"
...
## Overview
Compresses 100-line stack traces into single-line root cause statements.

---

## Operational Directives and Agent Execution Rules
When applying **Single-Line Error Summaries**, the AI agent or LLM runtime MUST adhere to the following rules:
