---
title: "Exclude Vendor Directories"
description: "Ignores vendor, dist, and target directories in file listing tools."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, no-vendor-directory-scans"
...
## Overview
Ignores vendor, dist, and target directories in file listing tools.

---

## Operational Directives and Agent Execution Rules
When applying **Exclude Vendor Directories**, the AI agent or LLM runtime MUST adhere to the following rules:
