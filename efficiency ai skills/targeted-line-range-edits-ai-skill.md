---
title: "Targeted Line Range Edits"
description: "Edits only lines 45-52 instead of outputting the entire 500-line module."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, targeted-line-range-edits"
category: "Token Efficiency and Performance"
---

# Targeted Line Range Edits

## Overview
Edits only lines 45-52 instead of outputting the entire 500-line module.

---

## Operational Directives and Agent Execution Rules
When applying **Targeted Line Range Edits**, the AI agent or LLM runtime MUST adhere to the following rules:
