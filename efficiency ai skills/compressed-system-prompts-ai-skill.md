---
title: "Compressed System Prompts"
description: "Removes adverbs, passive voice, and redundant instructions from system prompt definitions."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, compressed-system-prompts"
...
## Overview
Removes adverbs, passive voice, and redundant instructions from system prompt definitions.

---

## Operational Directives and Agent Execution Rules
When applying **Compressed System Prompts**, the AI agent or LLM runtime MUST adhere to the following rules:
