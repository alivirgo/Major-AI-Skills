---
title: "Reactive Wakeup Signaling"
description: "Relies on system completion notifications instead of polling status loops."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, reactive-wakeup-signaling"
category: "Token Efficiency and Performance"
---

# Reactive Wakeup Signaling

## Overview
Relies on system completion notifications instead of polling status loops.

---

## Operational Directives and Agent Execution Rules
When applying **Reactive Wakeup Signaling**, the AI agent or LLM runtime MUST adhere to the following rules:
