---
title: "Pruned Function Call Schemas"
description: "Removes optional unused parameters from tool schemas sent to LLM."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, schema-pruned-function-calling"
category: "Token Efficiency and Performance"
---

# Pruned Function Call Schemas

## Overview
Removes optional unused parameters from tool schemas sent to LLM.

---

## Operational Directives and Agent Execution Rules
When applying **Pruned Function Call Schemas**, the AI agent or LLM runtime MUST adhere to the following rules:
