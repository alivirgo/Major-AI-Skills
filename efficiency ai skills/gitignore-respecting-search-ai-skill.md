---
title: "Gitignore-Respecting Search"
description: "Ensures search tools automatically ignore tracked binary and build files."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, gitignore-respecting-search"
category: "Token Efficiency and Performance"
---

# Gitignore-Respecting Search

## Overview
Ensures search tools automatically ignore tracked binary and build files.

---

## Operational Directives and Agent Execution Rules
When applying **Gitignore-Respecting Search**, the AI agent or LLM runtime MUST adhere to the following rules:
