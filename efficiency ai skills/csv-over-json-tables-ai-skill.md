---
title: "CSV Data Representation"
description: "Uses CSV format instead of JSON arrays for structured data to save syntax tokens."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, csv-over-json-tables"
...
## Overview
Uses CSV format instead of JSON arrays for structured data to save syntax tokens.

---

## Operational Directives and Agent Execution Rules
When applying **CSV Data Representation**, the AI agent or LLM runtime MUST adhere to the following rules:
