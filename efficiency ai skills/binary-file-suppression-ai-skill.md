---
title: "Binary File Output Suppression"
description: "Prevents attempting to display binary/compiled assets in chat context."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, binary-file-suppression"
category: "Token Efficiency and Performance"
---

# Binary File Output Suppression

## Overview
Prevents attempting to display binary/compiled assets in chat context.

---

## Operational Directives and Agent Execution Rules
When applying **Binary File Output Suppression**, the AI agent or LLM runtime MUST adhere to the following rules:
