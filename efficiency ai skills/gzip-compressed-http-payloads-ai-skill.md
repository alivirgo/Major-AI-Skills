---
title: "Gzip HTTP Payload Compression"
description: "Compresses outgoing LLM API network requests."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, gzip-compressed-http-payloads"
category: "Token Efficiency and Performance"
---

# Gzip HTTP Payload Compression

## Overview
Compresses outgoing LLM API network requests.

---

## Operational Directives and Agent Execution Rules
When applying **Gzip HTTP Payload Compression**, the AI agent or LLM runtime MUST adhere to the following rules:
