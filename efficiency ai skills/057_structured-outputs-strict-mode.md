---
title: "Strict Structured Outputs Mode"
description: "Uses OpenAI/Gemini Strict JSON Schema output to eliminate markdown wrapping tags."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, structured-outputs-strict-mode"
category: "Token Efficiency and Performance"
---

# Strict Structured Outputs Mode

## Overview
Uses OpenAI/Gemini Strict JSON Schema output to eliminate markdown wrapping tags.

---

## Operational Directives and Agent Execution Rules
When applying **Strict Structured Outputs Mode**, the AI agent or LLM runtime MUST adhere to the following rules:
