---
title: "Batch File Creation Script"
description: "Generates multiple files via a single script execution call."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, batch-file-creation"
...
## Overview
Generates multiple files via a single script execution call.

---

## Operational Directives and Agent Execution Rules
When applying **Batch File Creation Script**, the AI agent or LLM runtime MUST adhere to the following rules:
