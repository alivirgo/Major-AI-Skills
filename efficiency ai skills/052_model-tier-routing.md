---
title: "Dynamic Model Tier Routing"
description: "Routes simple queries to fast lightweight models (Flash/Haiku) and complex reasoning to Pro/Claude."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, model-tier-routing"
...
## Overview
Routes simple queries to fast lightweight models (Flash/Haiku) and complex reasoning to Pro/Claude.

---

## Operational Directives and Agent Execution Rules
When applying **Dynamic Model Tier Routing**, the AI agent or LLM runtime MUST adhere to the following rules:
