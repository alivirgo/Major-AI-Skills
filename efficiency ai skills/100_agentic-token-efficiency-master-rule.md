---
title: "Agentic Token Efficiency Master Rule"
description: "The ultimate operational rule governing zero-waste token utilization for AI coding agents."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, agentic-token-efficiency-master-rule"
...
## Overview
The ultimate operational rule governing zero-waste token utilization for AI coding agents.

---

## Operational Directives and Agent Execution Rules
When applying **Agentic Token Efficiency Master Rule**, the AI agent or LLM runtime MUST adhere to the following rules:
