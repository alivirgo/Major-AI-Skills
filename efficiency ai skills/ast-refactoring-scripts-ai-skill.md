---
title: "AST-Based Automated Refactoring"
description: "Uses Python st or Babel scripts to perform mass refactoring locally without LLM token usage."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, ast-refactoring-scripts"
category: "Token Efficiency and Performance"
---

# AST-Based Automated Refactoring

## Overview
Uses Python st or Babel scripts to perform mass refactoring locally without LLM token usage.

---

## Operational Directives and Agent Execution Rules
When applying **AST-Based Automated Refactoring**, the AI agent or LLM runtime MUST adhere to the following rules:
