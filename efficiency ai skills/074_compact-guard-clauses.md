---
title: "Compact Guard Clauses"
description: "Uses early return guard clauses to reduce code nesting and token count."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, compact-guard-clauses"
...
## Overview
Uses early return guard clauses to reduce code nesting and token count.

---

## Operational Directives and Agent Execution Rules
When applying **Compact Guard Clauses**, the AI agent or LLM runtime MUST adhere to the following rules:
