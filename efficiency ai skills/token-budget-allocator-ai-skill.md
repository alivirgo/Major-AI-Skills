...
description: "Allocates explicit max token limits to system prompt, retrieved RAG context, and user query."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, token-budget-allocator"
...
## Overview
Allocates explicit max token limits to system prompt, retrieved RAG context, and user query.

---

## Operational Directives and Agent Execution Rules
When applying **Token Budget Allocation**, the AI agent or LLM runtime MUST adhere to the following rules:
