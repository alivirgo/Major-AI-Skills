---
title: "LM Studio Local Offloading"
description: "Routes simple sub-tasks to local LM Studio GGUF models to save cloud API tokens."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, lm-studio-local-offloading"
category: "Token Efficiency and Performance"
---

# LM Studio Local Offloading

## Overview
Routes simple sub-tasks to local LM Studio GGUF models to save cloud API tokens.

---

## Operational Directives and Agent Execution Rules
When applying **LM Studio Local Offloading**, the AI agent or LLM runtime MUST adhere to the following rules:
