---
title: "Dense Shorthand Notation"
description: "Uses token-efficient symbol mappings (e.g. -> for returns, => for implies, :: for scope) to compress prompts."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, dense-shorthand-notation"
category: "Token Efficiency and Performance"
---

# Dense Shorthand Notation

## Overview
Uses token-efficient symbol mappings (e.g. -> for returns, => for implies, :: for scope) to compress prompts.

---

## Operational Directives and Agent Execution Rules
When applying **Dense Shorthand Notation**, the AI agent or LLM runtime MUST adhere to the following rules:
