---
title: "Logit Bias Token Steering"
description: "Applies logit bias to encourage single-token answers (yes/
o)."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, logit-bias-token-steering"
...
## Overview
Applies logit bias to encourage single-token answers (yes/
o).

---

## Operational Directives and Agent Execution Rules
When applying **Logit Bias Token Steering**, the AI agent or LLM runtime MUST adhere to the following rules:
