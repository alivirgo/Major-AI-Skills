---
title: "Multi-Tool Batch Invocation"
description: "Issues multiple parallel tool calls in a single turn response."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, multi-tool-batch-invocation"
category: "Token Efficiency and Performance"
---

# Multi-Tool Batch Invocation

## Overview
Issues multiple parallel tool calls in a single turn response.

---

## Operational Directives and Agent Execution Rules
When applying **Multi-Tool Batch Invocation**, the AI agent or LLM runtime MUST adhere to the following rules:
