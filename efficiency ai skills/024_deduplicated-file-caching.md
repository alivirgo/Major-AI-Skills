---
title: "Deduplicated File Caching"
description: "Prevents re-reading the exact same file path twice within the same conversation trajectory."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, deduplicated-file-caching"
...
## Overview
Prevents re-reading the exact same file path twice within the same conversation trajectory.

---

## Operational Directives and Agent Execution Rules
When applying **Deduplicated File Caching**, the AI agent or LLM runtime MUST adhere to the following rules:
