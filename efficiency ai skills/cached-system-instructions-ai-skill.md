---
title: "Cached System Instructions"
description: "Reuses identical system instruction blocks across multi-agent workflows."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, cached-system-instructions"
...
## Overview
Reuses identical system instruction blocks across multi-agent workflows.

---

## Operational Directives and Agent Execution Rules
When applying **Cached System Instructions**, the AI agent or LLM runtime MUST adhere to the following rules:
