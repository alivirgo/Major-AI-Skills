---
title: "Lazy Dependency Context"
description: "Loads external package documentation only when explicit imports fail."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, lazy-dependency-loading"
category: "Token Efficiency and Performance"
---

# Lazy Dependency Context

## Overview
Loads external package documentation only when explicit imports fail.

---

## Operational Directives and Agent Execution Rules
When applying **Lazy Dependency Context**, the AI agent or LLM runtime MUST adhere to the following rules:
