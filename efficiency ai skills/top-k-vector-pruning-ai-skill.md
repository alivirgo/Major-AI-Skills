---
title: "Top-K Vector Retrieval Pruning"
description: "Limits vector search results to Top-3 most relevant chunks to prevent context dilution."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, top-k-vector-pruning"
category: "Token Efficiency and Performance"
---

# Top-K Vector Retrieval Pruning

## Overview
Limits vector search results to Top-3 most relevant chunks to prevent context dilution.

---

## Operational Directives and Agent Execution Rules
When applying **Top-K Vector Retrieval Pruning**, the AI agent or LLM runtime MUST adhere to the following rules:
