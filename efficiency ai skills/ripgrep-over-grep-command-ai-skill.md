---
title: "Ripgrep Tool Preference"
description: "Uses structured grep_search tool instead of running shell grep commands."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, ripgrep-over-grep-command"
...
## Overview
Uses structured grep_search tool instead of running shell grep commands.

---

## Operational Directives and Agent Execution Rules
When applying **Ripgrep Tool Preference**, the AI agent or LLM runtime MUST adhere to the following rules:
