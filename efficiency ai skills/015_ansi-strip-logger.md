---
title: "ANSI Strip Terminal Logger"
description: "Strips ANSI color codes from terminal command outputs before feeding into LLM context."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, ansi-strip-logger"
category: "Token Efficiency and Performance"
---

# ANSI Strip Terminal Logger

## Overview
Strips ANSI color codes from terminal command outputs before feeding into LLM context.

---

## Operational Directives and Agent Execution Rules
When applying **ANSI Strip Terminal Logger**, the AI agent or LLM runtime MUST adhere to the following rules:
