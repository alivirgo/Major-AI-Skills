---
title: "Deduplicate System Messages"
description: "Merges multiple system prompts into a single consolidated instruction header."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, avoid-duplicate-system-messages"
...
## Overview
Merges multiple system prompts into a single consolidated instruction header.

---

## Operational Directives and Agent Execution Rules
When applying **Deduplicate System Messages**, the AI agent or LLM runtime MUST adhere to the following rules:
