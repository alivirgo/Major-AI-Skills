---
title: "Temperature 0.0 Determinism"
description: "Sets temperature to 0 for code generation to reduce retry iterations."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, temperature-zero-determinism"
...
## Overview
Sets temperature to 0 for code generation to reduce retry iterations.

---

## Operational Directives and Agent Execution Rules
When applying **Temperature 0.0 Determinism**, the AI agent or LLM runtime MUST adhere to the following rules:
