---
title: "Comment Stripping Preprocessor"
description: "Strips verbose comments from ingested code before passing to LLM context."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, comment-stripping-preprocessor"
...
## Overview
Strips verbose comments from ingested code before passing to LLM context.

---

## Operational Directives and Agent Execution Rules
When applying **Comment Stripping Preprocessor**, the AI agent or LLM runtime MUST adhere to the following rules:
