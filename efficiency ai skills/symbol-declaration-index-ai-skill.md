---
title: "Symbol Declaration Indexing"
description: "Builds a 1-line per symbol index file to lookup functions without full source scans."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, symbol-declaration-index"
...
## Overview
Builds a 1-line per symbol index file to lookup functions without full source scans.

---

## Operational Directives and Agent Execution Rules
When applying **Symbol Declaration Indexing**, the AI agent or LLM runtime MUST adhere to the following rules:
