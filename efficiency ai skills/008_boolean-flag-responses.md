---
title: "Boolean Flag Responses"
description: "Requests single-word or boolean responses for diagnostic check prompts."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, boolean-flag-responses"
...
## Overview
Requests single-word or boolean responses for diagnostic check prompts.

---

## Operational Directives and Agent Execution Rules
When applying **Boolean Flag Responses**, the AI agent or LLM runtime MUST adhere to the following rules:
