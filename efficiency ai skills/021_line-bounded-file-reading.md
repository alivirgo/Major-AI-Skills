---
title: "Line-Bounded File Reading"
description: "Enforces reading max 200 specific lines rather than full 5,000-line source files."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, line-bounded-file-reading"
category: "Token Efficiency and Performance"
---

# Line-Bounded File Reading

## Overview
Enforces reading max 200 specific lines rather than full 5,000-line source files.

---

## Operational Directives and Agent Execution Rules
When applying **Line-Bounded File Reading**, the AI agent or LLM runtime MUST adhere to the following rules:
