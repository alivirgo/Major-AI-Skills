---
title: "Direct Tool Selection Protocol"
description: "Invokes the most specific tool immediately without exploratory generic calls."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, direct-tool-selection"
category: "Token Efficiency and Performance"
---

# Direct Tool Selection Protocol

## Overview
Invokes the most specific tool immediately without exploratory generic calls.

---

## Operational Directives and Agent Execution Rules
When applying **Direct Tool Selection Protocol**, the AI agent or LLM runtime MUST adhere to the following rules:
