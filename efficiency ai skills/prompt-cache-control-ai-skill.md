---
title: "Prompt Caching Header Directive"
description: "Leverages Anthropic/OpenAI prompt caching on static system prompts to save 90% input costs."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, prompt-cache-control"
category: "Token Efficiency and Performance"
---

# Prompt Caching Header Directive

## Overview
Leverages Anthropic/OpenAI prompt caching on static system prompts to save 90% input costs.

---

## Operational Directives and Agent Execution Rules
When applying **Prompt Caching Header Directive**, the AI agent or LLM runtime MUST adhere to the following rules:
