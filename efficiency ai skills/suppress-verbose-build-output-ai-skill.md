---
title: "Suppress Verbose Build Output"
description: "Appends > /dev/null or | Out-Null to non-essential build setup commands."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, suppress-verbose-build-output"
...
## Overview
Appends > /dev/null or | Out-Null to non-essential build setup commands.

---

## Operational Directives and Agent Execution Rules
When applying **Suppress Verbose Build Output**, the AI agent or LLM runtime MUST adhere to the following rules:
