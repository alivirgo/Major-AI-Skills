---
title: "Artifact Reuse Pattern"
description: "Modifies existing implementation plan markdown artifacts instead of creating new duplicates."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, artifact-reuse-pattern"
...
## Overview
Modifies existing implementation plan markdown artifacts instead of creating new duplicates.

---

## Operational Directives and Agent Execution Rules
When applying **Artifact Reuse Pattern**, the AI agent or LLM runtime MUST adhere to the following rules:
