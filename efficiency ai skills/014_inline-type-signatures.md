---
title: "Inline Type Signatures"
description: "Uses inline TypeScript/Python type hints instead of separate verbose docstrings."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, inline-type-signatures"
...
## Overview
Uses inline TypeScript/Python type hints instead of separate verbose docstrings.

---

## Operational Directives and Agent Execution Rules
When applying **Inline Type Signatures**, the AI agent or LLM runtime MUST adhere to the following rules:
