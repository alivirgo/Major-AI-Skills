---
title: "In-Place File Mutation"
description: "Uses direct string replacement tools rather than creating temporary duplicate files."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, in-place-file-mutation"
...
## Overview
Uses direct string replacement tools rather than creating temporary duplicate files.

---

## Operational Directives and Agent Execution Rules
When applying **In-Place File Mutation**, the AI agent or LLM runtime MUST adhere to the following rules:
