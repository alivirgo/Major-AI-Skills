---
title: "OpenAPI Endpoint Filtering"
description: "Extracts only the target route schema from large 10,000-line OpenAPI specs."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, openapi-endpoint-filtering"
...
## Overview
Extracts only the target route schema from large 10,000-line OpenAPI specs.

---

## Operational Directives and Agent Execution Rules
When applying **OpenAPI Endpoint Filtering**, the AI agent or LLM runtime MUST adhere to the following rules:
