---
title: "Speculative Decoding Alignment"
description: "Formats prompts to match target draft model patterns for faster speculative decoding."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, speculative-decoding-prompting"
...
## Overview
Formats prompts to match target draft model patterns for faster speculative decoding.

---

## Operational Directives and Agent Execution Rules
When applying **Speculative Decoding Alignment**, the AI agent or LLM runtime MUST adhere to the following rules:
