---
title: "Scratch File Isolation"
description: "Stores temporary test scripts under scratch directory to keep workspace clean."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, scratch-file-isolation"
category: "Token Efficiency and Performance"
---

# Scratch File Isolation

## Overview
Stores temporary test scripts under scratch directory to keep workspace clean.

---

## Operational Directives and Agent Execution Rules
When applying **Scratch File Isolation**, the AI agent or LLM runtime MUST adhere to the following rules:
