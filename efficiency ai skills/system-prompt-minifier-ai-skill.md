---
title: "System Prompt Minifier Script"
description: "Automated script that strips whitespace and comments from agent prompt files."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, system-prompt-minifier"
category: "Token Efficiency and Performance"
---

# System Prompt Minifier Script

## Overview
Automated script that strips whitespace and comments from agent prompt files.

---

## Operational Directives and Agent Execution Rules
When applying **System Prompt Minifier Script**, the AI agent or LLM runtime MUST adhere to the following rules:
