---
title: "Bounded Browser Subagent Tasks"
description: "Defines explicit stop conditions for browser automation tasks to avoid infinite loops."
keywords: "efficiency, token reduction, prompt optimization, AI performance, token compression, browser-subagent-task-bounding"
category: "Token Efficiency and Performance"
---

# Bounded Browser Subagent Tasks

## Overview
Defines explicit stop conditions for browser automation tasks to avoid infinite loops.

---

## Operational Directives and Agent Execution Rules
When applying **Bounded Browser Subagent Tasks**, the AI agent or LLM runtime MUST adhere to the following rules:
