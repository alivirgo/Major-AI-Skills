---
title: "Specify Who the Reader Is AI Skill"
description: "Tell the AI who will read the text (e.g., 'for a busy boss', 'for a 5th grader') so it matches the tone perfectly."
keywords: "common sense AI, easy AI tips, non-technical AI skills, AI efficiency, cost effective AI, specify-the-audience"
category: "Common Sense Everyday AI"
---

# Specify Who the Reader Is (AI Skill)

## Overview
Tell the AI who will read the text (e.g., 'for a busy boss', 'for a 5th grader') so it matches the tone perfectly.
